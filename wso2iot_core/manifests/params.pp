...
class wso2iot_core::params {
  ...
  if $::use_hieradata == "true" {
    $iot_wsdl_epr_prefix      = hiera('wso2::iot_wsdl_epr_prefix', undef)
    ...
    $iot_wsdl_epr_prefix ={
      http => {
        bind_address=> "iot.dev.wso2.org",
        prefix      => "http: //iot.dev.wso2.org:9763"
      },
      https=>{
        bind_address=> "iot.dev.wso2.org",
        prefix      => "https: //iot.dev.wso2.org:9443"
      }
    }
